...
const navItems = [{ label: "Resumen", href: "/", icon: Landmark }, { label: "Empresas", href: "/empresas", icon: Building2 }, { label: "Calendario", href: "/calendario", icon: CalendarDays }, { label: "Operaciones", href: "#", icon: ReceiptText }, { label: "Documentos", href: "#", icon: FileText }, { label: "Equipo", href: "#", icon: UsersRound }];
